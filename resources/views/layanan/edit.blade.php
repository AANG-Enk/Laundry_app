    ...
    <div class="bk-card">
        ...
        <form id="layananForm">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="estimasi_jam" id="estimasi_jam" class="form-control">
            </div>
...
fetch(`/api/layanans/${id}`)
    ...
    .then(layanan => {
        ...
        document.getElementById('estimasi_jam').value = layanan.estimasi_jam;
    });
